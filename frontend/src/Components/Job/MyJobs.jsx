                        ...
                        <div className="content">
                          <div className="short_fields">
                            ...
                            <div>
                              <span>Salary:  { " "}
                              {
                                element.fixedSalary ? (<input type='number' value={element.fixedSalary}
                            ...
                            <div>
                              <span>Expired:</span>
                              <select value={element.expired} onChange={(e) => handleInputChange(element._id, "expired", e.target.value)}
                              disabled={editingMode !== element._id ? true : false}>
                          ...
                          <div className="long_field">
                            <div>
                              ...
                              <textarea rows = "5" value={element.description} onChange={(e) => handleInputChange(element._id, "description", e.target.value)}
                              disabled={editingMode !== element._id ? true : false}></textarea>
                            </div>
                            <div>
                              <span>Location:</span>
                              <textarea rows = "5" value={element.location} onChange={(e) => handleInputChange(element._id, "location", e.target.value)}
                              disabled={editingMode !== element._id ? true : false}></textarea>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="edit_btn_wrapper">
                            {editingMode === element._id ? (
                              <>
                                ...
                                <button onClick={() => handleDisableEdit(element._id)}
                                className='cross_btn'>
                                  <RxCross2/>
                                </button>
                              </>
